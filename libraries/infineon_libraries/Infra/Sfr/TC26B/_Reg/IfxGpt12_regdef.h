...
{
    unsigned int T2:16;                     /**< \brief [15:0] Timer T2 (rwh) 寄存器值*/
    unsigned int reserved_16:16;            /**< \brief \internal Reserved 保留项 */
} Ifx_GPT12_T2_Bits;
...
typedef union
{
    unsigned int U;                         /**< \brief Unsigned access 无符号数*/
    signed int I;                           /**< \brief Signed access 有符号*/
    Ifx_GPT12_T2_Bits B;                    /**< \brief Bitfield access 位域*/
} Ifx_GPT12_T2;
