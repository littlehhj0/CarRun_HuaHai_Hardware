...
/** \brief PT1 object definition对象定义.
 */
typedef struct
{
...
/** \brief PT1 configuration 配置*/
typedef struct
{
    float32 cutOffFrequency; /**< \brief Cut off frequency截止频率 */
    float32 gain;            /**< \brief Gain增益 */
    float32 samplingTime;    /**< \brief Sampling time采样时间 */
